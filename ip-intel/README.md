...
Point it at any IPv4/IPv6 address or CIDR and it answers the four questions you actually ask about an IP:
...
# A whole subnet (samples a representative host in the block)
ipintel 108.186.55.0/24
...
A **CIDR** is reported via a representative host inside it — the covering prefix, RDAP block, and BGP origin are identical for the whole range.
